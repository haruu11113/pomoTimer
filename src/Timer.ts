...
export class Timer {
  ...
  startWork(): void {
    const timerMinuteElem: HTMLInputElement = <HTMLInputElement>(
      document.getElementById("timerMinute")
    );
    const timerSecondElem: HTMLInputElement = <HTMLInputElement>(
      document.getElementById("timerSecond")
    );
    this.startTimer(
      timerMinuteElem,
      timerSecondElem,
  ...
  stopTimer(): void {
    if (this.timerInterval) {
      const pieElem: HTMLInputElement = <HTMLInputElement>(
  ...
  startTimer(
    tMinElem: HTMLInputElement,
    tSecElem: HTMLInputElement,
    title: string,
    body: string
  ): void {
    const pieElem: HTMLInputElement = <HTMLInputElement>(
  ...
  setButton(stateName: string): void {
    ...
    const startButtonElem: HTMLElement = <HTMLElement>(
  ...
  setTimer(minute: number): void {
    ...
    const timerElem: HTMLInputElement = <HTMLInputElement>(
